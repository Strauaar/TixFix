...
Ticket.create(seller_id: demo_user1.id, buyer_id: demo_user2.id, event_id: subevent.id, price: 100, type_of: "General Admission", row: "GA")
Ticket.create(seller_id: demo_user1.id, event_id: subevent.id, price: 120, type_of: "General Admission", row: "GA")
